...
const WallTwo = (props) => {
  ...
  if (!props.works.wall2) {
    ...
    return (
      <View style={styles.wrapper}>
        {props.works.wall2.user_selections.map( work => (
        ...
        {props.works.wall2.captions.map( caption => (
...
const ConnectedWallTwo = connect(WallTwo);
export default ConnectedWallTwo;
