...
const WallOne = (props) => {
  ...
  if (!props.works.wall1) {
    ...
    return (
      <View style={styles.wrapper}>
        {props.works.wall1.user_selections.map( work => (
        ...
        {props.works.wall1.captions.map( caption => (
...
const ConnectedWallOne = connect(WallOne);
export default ConnectedWallOne;
