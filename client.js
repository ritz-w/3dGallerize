...
function init(bundle, parent, options = {}) {
  ...
  const leftPanel = new Surface(1500, 1000, Surface.SurfaceShape.Flat);
  leftPanel.setAngle(
  ...
  r360.renderToSurface(
    r360.createRoot('WallOne'),
    leftPanel,
  );
  r360.renderToSurface(
    r360.createRoot('WallThree'),
    rightPanel,
  );
   r360.renderToSurface(
    r360.createRoot('WallTwo'),
    frontPanel,
  );

  r360.compositor.setBackground('./static_assets/eqjuirect.jpg');
}
